    ...
    <div className="group bg-white rounded-xl border border-gray-200 hover:border-gray-300 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden">
      ...
      <div className="relative h-48 bg-gray-100 overflow-hidden">
        ...
        <div className="absolute top-3 right-3">
          <div className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${statusStyles.bg} ${statusStyles.text} backdrop-blur-sm`}>
            <div className={`w-2 h-2 ${statusStyles.dot} rounded-full mr-2`}></div>
      ...
      <div className="p-6">
        ...
        >
          ...
          <svg className="ml-2 -mr-1 w-4 h-4 group-hover/btn:translate-x-0.5 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
