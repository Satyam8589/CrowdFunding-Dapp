        ...
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-8">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mb-6">
              To create a campaign, you need to connect your MetaMask wallet. This ensures you can manage your campaign and receive funds.
            </p>
            ...
            {window.ethereum ? (
              ...
              <a
                ...
                className="w-full inline-block bg-orange-600 hover:bg-orange-700 text-white font-medium py-2 px-4 rounded-lg transition-colors mb-3"
              >
                Install MetaMask
              </a>
            )}
