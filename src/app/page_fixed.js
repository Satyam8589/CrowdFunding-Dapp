...
export default function Home() {
  ...
  // Get current network - only run on client side
  useEffect(() => {
    if (!isClient) return;
            ...
            {isNetworkError ? (
              ...
              <>
                ...
                <ul className="text-left max-w-2xl mx-auto mb-6 space-y-2">
                  ...
                  <li className="flex items-center text-gray-700">
                    <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                    Your wallet provider is having connectivity issues
                  </li>
                  <li className="flex items-center text-gray-700">
                    <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                    The blockchain RPC endpoint is temporarily unavailable
                  </li>
                </ul>
                ...
                {showDebugger && contractDiagnosis && (
                  <div className="mb-8">
                    <ContractDebugger diagnosis={contractDiagnosis} />
                  </div>
                )}
              </>
            )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Support innovative projects and help bring dreams to life through blockchain-powered crowdfunding
          </p>
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-gray-600 text-center max-w-2xl mx-auto">
                Discover amazing projects from our community. Every contribution makes a difference!
              </p>
            </div>
        ...
        >
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Secure Funding</h3>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <p className="text-gray-600 text-sm">
              Join a thriving community of innovators, creators, and supporters making dreams come true.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <p className="text-gray-600 text-sm">
              Launch your campaign in minutes and start receiving contributions immediately.
            </p>
          </div>
        </div>
        ...
        >
          <div className="text-center">
            ...
            <p className="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
              Join thousands of successful projects that have raised millions through our platform. 
