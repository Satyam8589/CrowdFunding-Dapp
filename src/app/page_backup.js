...
export default function Home() {
  const { campaigns, isLoading, error, contractDiagnosis, fetchCampaigns, fetchCampaignsWithRetry } = useCampaigns();
  ...
  if (error) {
    ...
    const isWalletError = error.includes('NO_WALLET_DETECTED') || error.includes('WALLET_NOT_CONNECTED');
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-gray-800 mb-4">
                {error.includes('NO_WALLET_DETECTED') ? 'Wallet Required' : 'Connect Your Wallet'}
              </h1>
            ...
            <div className="mt-8 max-w-2xl mx-auto p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <h3 className="font-semibold text-blue-800 mb-2">What you can do once connected:</h3>
    ...
    if (error.includes('could not decode result data') || error.includes('Contract') || isNetworkError) {
      ...
      <div className="min-h-screen bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-800 mb-4">
              {isNetworkError ? 'Wrong Network Detected' : 'Contract Connection Issue'}
            </h1>
            
            {isNetworkError ? (
              <div className="mb-8">
                <p className="text-gray-600 mb-6">
                  You're connected to the wrong blockchain network. This app requires Sepolia testnet.
                </p>
                <NetworkSwitcher 
              ...
              <>
                <p className="text-gray-600 mb-6">
                  We're having trouble connecting to the smart contract. This usually happens when:
                </p>
                <ul className="text-left max-w-2xl mx-auto mb-6 space-y-2">
                  <li className="flex items-center text-gray-700">
                    <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                    You're connected to the wrong network (should be Sepolia)
                  </li>
                  <li className="flex items-center text-gray-700">
                    <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
          ...
          {contractDiagnosis && (
            <div className="mt-8 max-w-2xl mx-auto p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              ...
              <p className="text-yellow-700 whitespace-pre-line">{contractDiagnosis.issue}</p>
    ...
    <div className="min-h-screen overflow-hidden">
      ...
      <section className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-800 text-white py-20 overflow-hidden">
        ...
        <div className={`relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <p className={`text-xl md:text-2xl mb-8 max-w-3xl mx-auto transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'}`}>
          ...
          <div className={`flex flex-col sm:flex-row gap-4 justify-center transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'}`}>
            <Link
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className={`text-center mt-12 transform transition-all duration-1000 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'}`}>
                <Link
                  href="/campaigns"
            ...
            <div className="text-center py-12 animate-fade-in">
              <div className="bg-gray-50 border border-gray-200 rounded-2xl p-12 max-w-lg mx-auto">
                ...
                <p className="text-gray-600 mb-6 text-lg">No campaigns available yet.</p>
                <Link
                  href="/campaigns/create"
            ...
            {[
              {
                ...
                description: "Set up your campaign with a title, description, target amount, and deadline.",
              ...
              },
              {
                ...
                description: "Share your campaign and receive ETH contributions from supporters worldwide.",
              ...
              },
              {
                ...
                description: "After the deadline, withdraw your raised funds (minus 1% platform fee).",
              ...
              <div
                key={index}
                className={`group text-center transform transition-all duration-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
                style={{ transitionDelay: `${index * 200}ms` }}
              >
                <div className="relative mb-8">
                  <div className={`w-20 h-20 bg-gradient-to-r ${item.color} rounded-2xl flex items-center justify-center mx-auto shadow-lg group-hover:shadow-2xl transition-all duration-300 transform group-hover:scale-110 group-hover:-translate-y-2`}>
